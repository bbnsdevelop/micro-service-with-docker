...
Run com.bbnsdevelop.springboot.web.SpringBootFirstWebApplication as a Java Application.
...
- http://localhost:8080/login with bbnsdevelop/dummy as credentials
- You can add, delete and update your todos
- Spring Security is used to secure the application
- `com.bbnsdevelop.springboot.web.security.SecurityConfiguration` contains the in memory security credential configuration.
...
+----+--------------+---------+----------------------------+-------------+
|  1 | Default Desc | 0       | 2019-06-26 18:30:00.000000 | bbnsdevelop |
+----+--------------+---------+----------------------------+-------------+
